...
<body>
    ...
    <div id="cashierPage" class="page">
        ...
        <nav class="nav-tabs">
            ...
            <button class="nav-tab" onclick="showTab('employeesTabCashier')">
        ...
        <main class="main-content">
            ...
            <!-- قسم الموظفين (للكاشير) -->
            <div id="employeesTabCashier" class="tab-content">
                <div class="section-header">
                    <h2><i class="fas fa-user-tie"></i> إدارة الموظفين</h2>
                    <button class="add-btn" onclick="showAddEmployeeModal()">
                        <i class="fas fa-plus"></i>
                        إضافة موظف
                    </button>
                </div>
                ...
                <div class="employees-table">
                    <table id="employeesTableCashier">
                        <thead>
                            <tr>
                                <th>اسم الموظف</th>
                                <th>رقم التليفون</th>
                        ...
                        <tbody id="employeesTableBodyCashier">
                            <!-- سيتم ملء البيانات ديناميكياً -->
                        </tbody>
                    </table>
                </div>
...
<div id="accountantPage" class="page">
            ...
            <form id="addCategoryForm" onsubmit="event.preventDefault(); addCategory();">
                ...
                <div class="form-group">
                    ...
                    <select id="formType" required>
                        ...
                        <option value="سلف_موظف">سلف موظف</option>
                    </select>
                </div>
    ...
    <label for="pinExpenseFormToggle">تثبيت النموذج:</label>
    <label class="switch">
        ...
        <span class="slider round"></span>
            ...
            <form id="addExpenseForm" onsubmit="event.preventDefault(); addExpense();">
                <div class="form-group">
                   ...
                   <input type="hidden" id="selectedExpenseCategoryId">
...
<input type="hidden" id="selectedExpenseCategoryFormType">
                    <input type="hidden" id="selectedExpenseCategoryCustomFields">
                </div>
                <!-- إضافة هذا الكود داخل نموذج إضافة المصروفات -->
